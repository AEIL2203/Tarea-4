...
public class Tarea_4_Progra extends javax.swing.JFrame {

    public Tarea_4_Progra() {
        initComponents();
        try {
            String ip = InetAddress.getLocalHost().getHostAddress();
            jLabelIP.setText("IP Local: " + ip);
        } catch (UnknownHostException ex) {
            Logger.getLogger(Tarea_4_Progra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Tarea_4_Progra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tarea_4_Progra().setVisible(true);
            }
        });
    }
    ...
    private static class FileUtils {
        private static void copyFile(File sourceFile, File target) throws IOException {
